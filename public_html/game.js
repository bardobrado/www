class Game {
	...
	init() {
        ...
        var vertices = [];
        var scale = 1.77;
        var material1 = new THREE.LineBasicMaterial( {color: 0xa0a0a0, opacity: 1, side: THREE.DoubleSide, lights: false} );
        material1.transparent = true;
        var materialcylinder = new THREE.LineBasicMaterial( {color: 0xfcdbff, opacity: 1, side: THREE.DoubleSide, lights: false} );
    
        var meshlinematerial = new MeshLineMaterial({color: 0x993399});
	...
	animate() {
        ...
        window.addEventListener('mousedown', function(){game.onDocMouseDown(window.event);}, false);
